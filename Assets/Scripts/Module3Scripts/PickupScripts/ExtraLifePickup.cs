...
public class ExtraLifePickup : MonoBehaviour
{
    ...
    public ExtraLifePowerup powerup; // Refrence to HealthPowerup script to use its functions in this code - access the healthToAdd variable from HealthPowerup script
